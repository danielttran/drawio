...
- **SVG rasterizer library:** The v2 bridge intentionally renders embedded SVG artwork as a loud stub. A concrete SVG library still requires license clearance before shipping preview/print binaries with real SVG artwork.
